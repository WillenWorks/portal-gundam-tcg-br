...
export function CardCornerActions({ actions, className }: CardCornerActionsProps) {
  ...
  return (
    <div
      ...
      // botões. `-top-2` põe a fila levemente pra fora da carta.
    ...
    >
      {actions.map((a) => (
        <button
          ...
          className={cn(
            "flex size-6 items-center justify-center rounded-none border border-black/40 shadow-lg transition-colors disabled:opacity-40 motion-reduce:transition-none",
            TONE[a.tone],
          )}
        >
