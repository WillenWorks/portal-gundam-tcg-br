 ...
 * atualmente implementadas no motor do simulador (ST01..ST04, ST06, GD01 e GD02).
 *
 * Indexado pelo código oficial da carta em maiúsculas (ex: "ST01-001", "GD01-001", "GD02-001").
 */
