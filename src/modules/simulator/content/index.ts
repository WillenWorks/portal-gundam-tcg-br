...
/**
 * Todo EffectSpec real cadastrado até agora (ST01 + ST02 + ST03 + ST04 + GD01, docs/18
 * "Cobertura real" + docs/41 waves ST03/ST04 + GD01). Ponto único de agregação pra quem
